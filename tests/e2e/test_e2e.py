...
def test_hello_world(page, fastapi_server):
    ...
    the main header (`<h1>`) correctly displays tassert page.inner_text('#result') == 'Result: 15'
he text "Hello World". This ensures
...
def test_calculator_add(page, fastapi_server):
    ...
    page.wait_for_selector('#result', state='visible', timeout=2000)
    result_text = page.inner_text('#result')
    assert 'Result: 15' in result_text
